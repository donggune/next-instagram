...
export default function NewPost({ user: { username, image } }: Props) {
  ...
  return (
    <section className="w-full max-w-xl flex flex-col items-center mt-6">
      ...
      {error && (
        <p className="w-full bg-red-100 text-red-600 text-center p-t mb-4 font-bold">
          {error}
        </p>
      )}
      <PostUserAvatar username={username} image={username} />
        ...
        >
          ...
          {!file && (
            <div className="flex flex-col items-center pointer-events-none">
              <FilesIcon />
              <p>drag adn Drop your image here or click</p>
            </div>
          )}
          {file && (
